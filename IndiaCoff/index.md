...
CoffIndia1 <- data.frame(Year = levels(as.factor(CoffIndia$Year)), Arabica = levels(as.factor(CoffIndia$Value[CoffIndia$Category == "Arabica"])), Robusta = levels(as.factor(CoffIndia$Value[CoffIndia$Category == "Robusta"])) )
